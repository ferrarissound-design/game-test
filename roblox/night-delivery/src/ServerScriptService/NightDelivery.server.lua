...
local function addBikeVisual(player)
	...
	bikePart("Handlebar", Vector3.new(1.50, 0.14, 0.16), CFrame.new(0, -0.28, -0.72), trimColor)
	bikePart("HandlebarGripLeft", Vector3.new(0.20, 0.16, 0.18), CFrame.new(-0.76, -0.28, -0.72), rubberColor)
	bikePart("HandlebarGripRight", Vector3.new(0.20, 0.16, 0.18), CFrame.new(0.76, -0.28, -0.72), rubberColor)
